...
import zirve.loves.mans.features.gui.font.CustomFont;
...
public class TextManager
    ...
    public void init(boolean startup) {
        FontMod cFont = TurcoHack.moduleManager.getModuleByClass(FontMod.class);
        try {
    ...
    public void drawString(String text, float x, float y, int color, boolean shadow) {
        if (TurcoHack.moduleManager.isModuleEnabled(FontMod.getInstance().getName())) {
            if (shadow) {
