package zirve.loves.mans.features;
...
import zirve.loves.mans.manager.TextManager;
...
public class Feature
    ...
    public TextManager renderer = TurcoHack.textManager;
    private String name;
    ...
    public Setting register(Setting setting) {
        ...
        if (this instanceof Module && Feature.mc.currentScreen instanceof TurcoHackGui) {
            TurcoHackGui.getInstance().updateModule((Module) this);
        }
        return setting;
    }
