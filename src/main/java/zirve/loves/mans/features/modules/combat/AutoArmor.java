...
public class AutoArmor
    ...
    public void onTick() {
        ...
        if (this.timer.passedMs((int) ((float) this.delay.getValue().intValue() * TurcoHack.serverManager.getTpsFactor()))) {
            if (!this.taskList.isEmpty()) {
