...
class NoRender
    ...
    public Setting < Boolean > explosions = this.register ( new Setting <> ( "Explosions" , Boolean.FALSE , "Removes crystal explosions." ) );
    ...
    public Setting < Float > scale = this.register ( new Setting < Object > ( "Scale" , 0.5f , 0.5f , 1.0f , v -> this.boss.getValue ( ) == Boss.MINIMIZE || this.boss.getValue ( ) != Boss.STACK , "Scale of the bars." ) );
    ...
    public
    void doVoidFogParticles ( final int posX , final int posY , final int posZ ) {
    ...
    public
    void showBarrierParticles ( final int x , final int y , final int z , final int offset , final Random random , final boolean holdingBarrier , final BlockPos.MutableBlockPos pos ) {
