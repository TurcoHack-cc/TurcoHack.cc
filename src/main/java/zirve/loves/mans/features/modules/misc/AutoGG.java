...
public class AutoGG
    ...
    public Setting<String> custom = this.register(new Setting<String>("Custom", "Ez TurcoHack on top"));
    public Setting<String> test = this.register(new Setting<String>("Test", "write some shit"));
    private ConcurrentHashMap<String, Integer> targetedPlayers = null;

    public AutoGG() {
        super("AutoEz", "Sends msg after you kill someone", Module.Category.MISC, true, false, false);
        this.setInstance();
    }
