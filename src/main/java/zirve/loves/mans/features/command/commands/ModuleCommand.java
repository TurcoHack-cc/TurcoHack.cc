...
import zirve.loves.mans.manager.ConfigManager;
...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : TurcoHack.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module1 : TurcoHack.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = TurcoHack.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = TurcoHack.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
